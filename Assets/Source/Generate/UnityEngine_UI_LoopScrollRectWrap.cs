...
public class UnityEngine_UI_LoopScrollRectWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("RegisterInitCallback", RegisterInitCallback);
		L.RegFunction("__eq", op_Equality);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.RegVar("prefabSource", get_prefabSource, set_prefabSource);
		L.RegVar("CachePool", get_CachePool, set_CachePool);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int RegisterInitCallback(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
	...
	static int get_prefabSource(IntPtr L)
	{
		...
		try
		{
			...
			UnityEngine.GameObject ret = obj.prefabSource;
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_CachePool(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.LoopScrollRect obj = (UnityEngine.UI.LoopScrollRect)o;
			UnityEngine.Transform ret = obj.CachePool;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index CachePool on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_CachePool(IntPtr L)
	{
		object o = null;
